                        ...
                        body: JSON.stringify({
                            ...
                            ...(this.proxyMode ? {
                                ...
                                ...(this.globalSettings.proxy.backend_type === 'vllm' ? {
                                    vllm_image: this.globalSettings.proxy.vllm?.image || '',
                                    vllm_model: this.globalSettings.proxy.vllm?.model || '',
                                    vllm_served_model_name: this.globalSettings.proxy.vllm?.served_model_name || '',
                                    vllm_max_model_len: this.globalSettings.proxy.vllm?.max_model_len || this.globalSettings.sampling.max_context_window,
                                    vllm_gpu_memory_utilization: this.globalSettings.proxy.vllm?.gpu_memory_utilization ?? 0.8,
                                    vllm_max_num_seqs: this.globalSettings.proxy.vllm?.max_num_seqs || this.globalSettings.scheduler.max_concurrent_requests,
                                    vllm_port: this.globalSettings.proxy.vllm?.port || 8000,
                                    vllm_hf_home: this.globalSettings.proxy.vllm?.hf_home || '${HOME}/.cache/huggingface',
                                    vllm_generation_config: this.globalSettings.proxy.vllm?.generation_config || 'vllm',
                                    vllm_default_chat_template_kwargs: this.globalSettings.proxy.vllm?.default_chat_template_kwargs || '',
                                    vllm_trust_remote_code: !!this.globalSettings.proxy.vllm?.trust_remote_code,
                                    vllm_enforce_eager: !!this.globalSettings.proxy.vllm?.enforce_eager,
                                    vllm_enable_auto_tool_choice: !!this.globalSettings.proxy.vllm?.enable_auto_tool_choice,
                                    vllm_tool_call_parser: this.globalSettings.proxy.vllm?.tool_call_parser || '',
                                    vllm_reasoning_parser: this.globalSettings.proxy.vllm?.reasoning_parser || '',
                                    vllm_dtype: this.globalSettings.proxy.vllm?.dtype || '',
                                    vllm_tokenizer: this.globalSettings.proxy.vllm?.tokenizer || '',
                                    vllm_tokenizer_mode: this.globalSettings.proxy.vllm?.tokenizer_mode || '',
                                    vllm_revision: this.globalSettings.proxy.vllm?.revision || '',
                                    vllm_load_format: this.globalSettings.proxy.vllm?.load_format || '',
                                    vllm_quantization: this.globalSettings.proxy.vllm?.quantization || '',
                                    vllm_download_dir: this.globalSettings.proxy.vllm?.download_dir || '',
                                    vllm_max_num_batched_tokens: this.globalSettings.proxy.vllm?.max_num_batched_tokens || '',
                                    ...(this.globalSettings.proxy.vllm?.enable_chunked_prefill == null || this.globalSettings.proxy.vllm?.enable_chunked_prefill === '' ? {} : { vllm_enable_chunked_prefill: this.globalSettings.proxy.vllm.enable_chunked_prefill }),
                                    ...(this.globalSettings.proxy.vllm?.enable_prefix_caching == null || this.globalSettings.proxy.vllm?.enable_prefix_caching === '' ? {} : { vllm_enable_prefix_caching: this.globalSettings.proxy.vllm.enable_prefix_caching }),
                                    vllm_kv_cache_dtype: this.globalSettings.proxy.vllm?.kv_cache_dtype || '',
                                    vllm_cpu_offload_gb: this.globalSettings.proxy.vllm?.cpu_offload_gb ?? 0,
                                    vllm_swap_space: this.globalSettings.proxy.vllm?.swap_space ?? 0,
                                    vllm_tensor_parallel_size: this.globalSettings.proxy.vllm?.tensor_parallel_size || 1,
                                    vllm_pipeline_parallel_size: this.globalSettings.proxy.vllm?.pipeline_parallel_size || 1,
                                    vllm_uvicorn_log_level: this.globalSettings.proxy.vllm?.uvicorn_log_level || '',
                                    vllm_disable_log_stats: !!this.globalSettings.proxy.vllm?.disable_log_stats,
                                    vllm_extra_args_json: this.globalSettings.proxy.vllm?.extra_args_json || '[]',
